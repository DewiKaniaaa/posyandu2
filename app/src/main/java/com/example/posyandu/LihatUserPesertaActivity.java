...
public class LihatUserPesertaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_user_peserta);

        tvNama = findViewById(R.id.text_nama_peserta);
